...
namespace Entity.Modules
{
    public partial class CateringDBContext : DbContext
    {
        ...
        public virtual DbSet<TblDishes> TblDishes { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TblCategories>(entity =>
            {
                ...
                entity.Property(e => e.CategoryId).HasColumnName("ctaegoryId");
            ...
            modelBuilder.Entity<TblDetailsEvent>(entity =>
            {
                entity.HasKey(e => e.EventId)
                    .HasName("PK__tbl_deta__2DC7BD0929243D26");
                ...
                entity.HasOne(d => d.Dishes)
                    ...
                    .HasConstraintName("FK__tbl_detai__dishe__35BCFE0A");
            });

            modelBuilder.Entity<TblDishes>(entity =>
            {
                entity.HasKey(e => e.DishesId)
                    .HasName("PK__tbl_dish__40AC0D390D460B82");

                entity.ToTable("tbl_dishes");

                entity.Property(e => e.DishesId)
            ...
            modelBuilder.Entity<TblProducts>(entity =>
            {
                entity.HasKey(e => e.ProductsId)
                    .HasName("PK__tbl_Prod__6CFE81971D082BB2");
            ...
            modelBuilder.Entity<TblProductsToRecipe>(entity =>
            {
                ...
                entity.HasOne(d => d.Products)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__tbl_Produ__produ__38996AB5");

                entity.HasOne(d => d.Recipes)
                    .WithMany(p => p.TblProductsToRecipe)
                    .HasForeignKey(d => d.RecipesId)
                    .HasConstraintName("FK__tbl_Produ__recip__398D8EEE");
            });
            ...
            modelBuilder.Entity<TblRecipesToOrder>(entity =>
            {
                ...
                entity.HasOne(d => d.Event)
                    ...
                    .HasConstraintName("FK__tbl_recip__event__3C69FB99");
